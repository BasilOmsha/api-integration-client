...
export const DATASETS: DatasetConfig[] = [
  ...
  },
  {
    ...
    description: '0 = Normal, 1 = Possible, 2 = High risk, 3 = Shortage. Updated every 3 minutes.',
    unit: 'status',
    chartType: 'step',
    maxRangeDays: 30,
  },
...
export const COMBO_DATASETS: ComboDatasetConfig[] = [
    ...
    },
    {
        ...
        series: [
        { datasetId: 75, label: 'Wind production', unit: 'MW', color: 'hsl(142, 71%, 45%)', yAxis: 'left' },
        { datasetId: 396, label: 'Emission factor', unit: 'gCO2/kWh', color: 'hsl(0, 72%, 51%)', yAxis: 'right' },
        ],
    },
    {
        ...
        series: [
            { datasetId: 248, label: "Solar Production", color: "#f59e0b", yAxis: "left", unit: "MW" },
            { datasetId: 396, label: 'Emission factor', unit: 'gCO2/kWh', color: 'hsl(0, 72%, 51%)', yAxis: 'right' },
        ],
    },
]