...
export const ChartCard = ({ isCombo, isLoading, isFullscreen, toggleFullscreen, children }: ChartCardProps) => {
  ...
  return (
    <>
      ...
      <Card
        className={isFullscreen ? 'fixed inset-0 z-50 flex flex-col rounded-none border-none' : 'h-full flex flex-col'}
